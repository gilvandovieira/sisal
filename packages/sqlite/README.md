...
| Dialect limitations | SQLite type affinity applies; booleans are stored as integers, and some PostgreSQL/MySQL DDL/index features are capability-gated or omitted.                    |
