...
Deno.test("parity: customType exposes dialectType escape hatch", () => {
  const extensions = defineTable("extensions", {
...
Deno.test("parity: placeholder() is a deferred parameter slot (~ sql.placeholder)", () => {
  ...
  assertEquals(orm.isSql(placeholder("id")), true);
...
// ---------------------------------------------------------------------------
// 3. Query builder — CTEs & set operations (docs/drizzle-parity.md §3)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// 3. Query builder — P7 ergonomics & subqueries (docs/drizzle-parity.md §3)
// ---------------------------------------------------------------------------
