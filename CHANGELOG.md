...
- **Examples: consolidated the three basics into the dialect-family taxonomy.**
  The three basics (`basic-postgres` + `basic-sqlite` + `basic-libsql`) become
  two — [`postgres-family-basic`](examples/postgres-family-basic/) (schema DDL +
