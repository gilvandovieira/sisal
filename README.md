...
| Target        | Install                                                                             |
| ------------- | ----------------------------------------------------------------------------------- |
| PostgreSQL    | `deno add jsr:@sisal/orm@0.12.0 jsr:@sisal/migrate@0.12.0 jsr:@sisal/pg@0.12.0`     |
| Neon          | `deno add jsr:@sisal/orm@0.12.0 jsr:@sisal/migrate@0.12.0 jsr:@sisal/neon@0.12.0`   |
| SQLite        | `deno add jsr:@sisal/orm@0.12.0 jsr:@sisal/migrate@0.12.0 jsr:@sisal/sqlite@0.12.0` |
| libSQL/Turso  | `deno add jsr:@sisal/orm@0.12.0 jsr:@sisal/migrate@0.12.0 jsr:@sisal/libsql@0.12.0` |
| MySQL/MariaDB | `deno add jsr:@sisal/orm@0.12.0 jsr:@sisal/migrate@0.12.0 jsr:@sisal/mysql@0.12.0`  |
