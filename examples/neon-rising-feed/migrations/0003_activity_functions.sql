...
-- implicit transaction without an interactive db.transaction(tx => { ... })
-- callback holding a connection open across round trips (the Deno Deploy /
-- Neon HTTP friendly shape; see the README "Important Neon note").
--
